import svgPaths from "./svg-skrxj6w69w";
...
export default function Frame2() {
  return (
    <div className="box-border content-stretch flex gap-[16px] items-center justify-center pb-0 pt-[24px] px-0 relative size-full">
      <Frame />
    </div>
  );
}