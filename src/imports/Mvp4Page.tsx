import svgPaths from "./svg-r0rxatmmec";
...
import { imgGeminiGeneratedImageV4Wy0Cv4Wy0Cv4Wy1, img1 } from "./svg-s0qem";
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 text-black">
      <p className="font-['YES_Gothic:Bold',sans-serif] relative shrink-0 text-[14px]">달달한허니빵</p>
      <p className="font-['YES_Gothic:Regular',sans-serif] relative shrink-0 text-[12px]">방조아님</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="box-border content-stretch flex flex-col h-[74px] items-start justify-between leading-[20px] not-italic pb-0 pt-[8px] px-0 relative shrink-0 text-center text-nowrap tracking-[-0.24px] w-[78px] whitespace-pre">
      <Frame32 />
      <p className="font-['YES_Gothic:Regular',sans-serif] relative shrink-0 text-[#f47f30] text-[12px]">@zzoa_bbang</p>
    </div>
  );
}
    ...
    <div className="absolute contents h-[60.446px] left-[95.16px] top-[8px] w-[72.438px]" data-name="bread_icon">
      <div className="absolute flex items-center justify-center left-[76.26px] size-[110.267px] top-[-16.83px]" style={{ "--transform-inner-width": "97.328125", "--transform-inner-height": "97.328125" } as React.CSSProperties}>
        <div className="flex-none rotate-[188.229deg] scale-y-[-100%]">
          <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[22.643px_28.493px] mask-size-[64.403px_54.397px] relative size-[97.337px]" data-name="앙버터 소금빵 1" style={{ maskImage: `url('${img1}')` }}>
...
function Frame28() {
  return (
    <div className="absolute content-stretch flex flex-col h-[52px] items-start left-0 top-[44px] w-[403px]">
      <Frame25 />
      <Frame33 />
      <Frame34 />
      <Cont />
...
function Frame26() {
  return (
    <div className="absolute bottom-0 h-[116px] left-0 w-[402px]">
      <DockBar1 />
    </div>
  );
}
...
export default function Mvp4Page() {
  return (
    <div className="bg-white relative size-full" data-name="MVP4_page">
      <Frame26 />
