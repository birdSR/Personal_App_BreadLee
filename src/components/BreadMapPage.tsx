...
export default function BreadMapPage() {
  ...
  return (
    <div className="bg-white relative w-full h-screen">
      {/* Header */}
      <div className="absolute top-0 left-0 right-0 h-[60px] bg-white z-10 flex items-center justify-center border-b border-[#e0e0e0]">
        <h1 className="font-['YES_Gothic:Bold',sans-serif] text-[18px] text-[#242121]">빵맵</h1>
      </div>

      {/* Map Placeholder */}
      <div className="absolute top-[60px] left-0 right-0 bottom-[112px] bg-[#f0f0f0] flex items-center justify-center">
